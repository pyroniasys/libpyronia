...
from pyronia.common import AppArmorException, debug, error, msg, cmd
import pyronia.easyprof
import optparse
import os
import pwd
import re
...
def aa_exec(command, opt, environ={}, verify_rules=[]):
    ...
    if opt.profile != None:
        ...
        easyp = pyronia.easyprof.AppArmorEasyProfile(binary, opt)
        params = pyronia.easyprof.gen_policy_params(policy_name, opt)

...
from pyronia.regex import RE_PROFILE_PTRACE, RE_PROFILE_NAME, strip_quotes
from pyronia.common import AppArmorBug, AppArmorException
from pyronia.rule import BaseRule, BaseRuleset, check_and_split_list, logprof_value_or_all, parse_modifiers, quote_if_needed
...
access_keywords         = ['r', 'w', 'rw', 'wr', 'read', 'write', 'readby', 'trace', 'tracedby']  # XXX 'wr' and 'write' accepted by the parser, but not documented in pyronia.d.pod
